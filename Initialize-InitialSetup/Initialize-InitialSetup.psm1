...
$NHKRepository = "https://github.com/NHK-Technologies-PVT-LTD/PublishedScripts.git"
############################################################## Functions
...
"@
    ...
    [Environment]::SetEnvironmentVariable("PSModulePath", $CurrentValue + [System.IO.Path]::PathSeparator + $NHKModulesRoot, "Machine")
...
Register-PSRepository -Name "NHKGitHubRepo" -SourceLocation $NHKRepository -PublishLocation $NHKRepository -InstallationPolicy "Trusted"

Write-EventLog -LogName "NHK" -Source "Admin Tasks" -EntryType Information -EventID 6450 -Message "GitHub Repository Successfully Registered"